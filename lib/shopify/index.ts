...
import {
  ...
  ShopifyCreateCartWithBuyerOperation,
...
export async function createCartWithBuyer(
  lineItems: { merchandiseId: string; quantity: number }[],
  buyerIdentity: CartBuyerIdentityInput,
  discountCodes?: string[]
): Promise<Cart> {
  const res = await shopifyFetch<ShopifyCreateCartWithBuyerOperation>({
    query: createCartWithBuyerMutation,
    variables: { lineItems, buyerIdentity, discountCodes },
  });
